...
HD_PWD='E:/Courses/FPGA course/Tutorial/FPGA_Tutorial/FIR_Design/FIR_Design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIR_TOP.tcl -notrace
