...
HD_PWD='E:/Courses/FPGA course/Tutorial/FPGA_Tutorial/FIR_Design/FIR_Design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIR_TOP.tcl
